...
sudo tar -czf /etc/ezcluster/demo/dump.tgz -C $PWD ./ezpublish_legacy/var/autoload ./ezpublish/EzPublishKernel.php ./ezpublish_legacy/settings/override ./ezpublish_legacy/settings/siteaccess/ ./ezpublish_legacy/var/ezdemo_site ./ezpublish/config/
