...
wget -O ezpublish5.tar.gz --no-check-certificate "http://packages.xrow.com/software/5.2/ezpublish5-5.2.0-ee-bul-full.tar.gz"
...
wget -O ezfind.tar.gz "http://packages.xrow.com/software/5.2/ezpublish5-5.2.0-ee-bul-full.tar.gz"
...
#rm -Rf ezpublish_legacy/extension/ezformtoken/
#sed -i "/^[[:blank:]]*csrf_protection:/,/^\:/ {
#	    0,/a/s|^[[:blank:]]*enabled\:[[:blank:]]*.*$|        enabled: false|
