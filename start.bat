...
rem CALL vagrant plugin install --plugin-source https://rubygems.org --plugin-prerelease vagrant-vbguest >> vagrant.log
rem CALL vagrant vbguest --do rebuild >> vagrant.log
rem CALL vagrant reload >> vagrant.log
